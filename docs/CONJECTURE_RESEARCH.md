...
is now implemented and tested offline. Its first authorized live attempt stopped
at initial-table validation; see the [failure report](research-runs/codex-shadow-day-2026-09-05.md).
The [v2 follow-up](research-runs/codex-shadow-day-v2-2026-09-05.md) separates roles
and factions and adds owner-lawful constraints; unknown-state encoding still
prevented a completed episode. Neither run is a successful model debate.
The [V3.1 continuation](research-runs/codex-shadow-day-v3-1-2026-09-05.md) now
completes the bounded sequence with candidate/assertion separation and phase-specific
output contracts. It is one traced episode with reused initial drafts, not a
general performance result or ordinary-mode integration.
...
models or change suspicion themselves. A first real Codex-account development
smoke run is recorded there, including its evidence-coverage shortcoming and
targeted follow-up. The subsequent frozen reserved-set check also passed;
see [the acceptance report](research-runs/codex-heldout-2026-09-05.md). This supports
proposing a shadow-observer debate experiment, not automatic suspicion updates.
